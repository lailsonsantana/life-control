			...
			{!telaEdicao && (
				<ContainerCriacao>
					...
					<div className="w-full">
						...
						<div className="flex flex-col mt-4 p-4 items-start space-y-8">
			...
			{telaEdicao && (
				<ContainerCriacao>
					<div className="flex flex-col gap-4">
						...
						<BasicSelect value={statusSelecionado!} onChange={setStatusSelecionado}/>
